...
PotentialPolicies = (
	...
	(True,"Additional Minimum Required EV Sales Percentage[passenger,LDVs]","Electric Vehicle Sales Mandate - Passenger LDVs",[0,1],"EV Sales Mandate"),
	...
	(True,"Additional EV Subsidy Percentage[passenger,LDVs]","Electric Vehicle Subsidy - Passenger LDVs",[0,0.147],"EV Subsidy"),
	(False,"LDVs Feebate Rate","Feebate",[0,1],"Feebate"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[gasoline vehicle,LDVs]","Fuel Economy Standard - Gasoline Engine LDVs",[0,0.875532],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[diesel vehicle,HDVs]","Fuel Economy Standard - Diesel Engine HDVs",[0,0.070217],"Vehicle Fuel Economy Standards"),
		(True,"Percentage Additional Improvement of Fuel Economy Std[diesel vehicle,LDVs]","Fuel Economy Standard - Gasoline Engine LDVs",[0,0.875532],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[gasoline vehicle,HDVs]","Fuel Economy Standard - Diesel Engine HDVs",[0,0.070217],"Vehicle Fuel Economy Standards"),
	...
	(True,"Fraction of TDM Package Implemented[passenger]","Transportation Demand Management - Passengers",[0,0.4],"Transportation Demand Management"),
	...
	(True,"Percent New Nonelec Component Sales Shifted to Elec[urban residential]","Building Component Electrification - Urban Residential",[0,1],"Building Component Electrification"),
	(True,"Percent New Nonelec Component Sales Shifted to Elec[rural residential]","Building Component Electrification - Rural Residential",[0,1],"Building Component Electrification"),
	(True,"Percent New Nonelec Component Sales Shifted to Elec[commercial]","Building Component Electrification - Commercial",[0,1],"Building Component Electrification"),
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,urban residential]","Building Energy Efficiency Standards - Urban Residential Heating",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,urban residential]","Building Energy Efficiency Standards - Urban Residential Cooling and Ventilation",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,urban residential]","Building Energy Efficiency Standards - Urban Residential Envelope",[0,0.29],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,urban residential]","Building Energy Efficiency Standards - Urban Residential Lighting",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,urban residential]","Building Energy Efficiency Standards - Urban Residential Appliances",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[other component,urban residential]","Building Energy Efficiency Standards - Urban Residential Other Components",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,rural residential]","Building Energy Efficiency Standards - Rural Residential Heating",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,rural residential]","Building Energy Efficiency Standards - Rural Residential Cooling and Ventilation",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,rural residential]","Building Energy Efficiency Standards - Rural Residential Envelope",[0,0.29],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,rural residential]","Building Energy Efficiency Standards - Rural Residential Lighting",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,rural residential]","Building Energy Efficiency Standards - Rural Residential Appliances",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[other component,rural residential]","Building Energy Efficiency Standards - Rural Residential Other Components",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,commercial]","Building Energy Efficiency Standards - Commercial Heating",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,commercial]","Building Energy Efficiency Standards - Commercial Cooling and Ventilation",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,commercial]","Building Energy Efficiency Standards - Commercial Envelope",[0,0.13],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,commercial]","Building Energy Efficiency Standards - Commercial Lighting",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,commercial]","Building Energy Efficiency Standards - Commercial Appliances",[0,0.1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[other component,commercial]","Building Energy Efficiency Standards - Commercial Other Components",[0,0.1],"Building Energy Efficiency Standards"),
	...
	(True,"Fraction of Commercial Components Replaced Annually due to Retrofitting Policy[heating]","Increased Retrofitting - Heating",[0,0.02],"Increased Retrofitting"),
	(True,"Fraction of Commercial Components Replaced Annually due to Retrofitting Policy[cooling and ventilation]","Increased Retrofitting - Cooling and Ventilation",[0,0.02],"Increased Retrofitting"),
	(True,"Fraction of Commercial Components Replaced Annually due to Retrofitting Policy[envelope]","Increased Retrofitting - Envelope",[0,0.02],"Increased Retrofitting"),
	...
	(True,"Fraction of Additional Demand Response Potential Achieved","Demand Response",[0,0.753344172],"Demand Response"),
	...
	(True,"Additional Battery Storage Annual Growth Percentage","Grid-Scale Electricity Storage",[0,0.0717],"Grid-Scale Electricity Storage"),
	(True,"Percentage Increase in Transmission Capacity vs BAU","Increase Transmission",[0,1],"Increase Transmission"),
	...
	(True,"Additional Renewable Portfolio Std Percentage","Renewable Portfolio Standard",[0,0.4885],"Renewable Portfolio Standard"),
	...
	(True,"Subsidy for Elec Production by Fuel[offshore wind es]","Subsidy for Electricity Production - Offshore Wind",[0,23],"Subsidy for Electricity Production"),

	# Industry Sector Policies
	(False,"Fraction of Cement Clinker Substitution Made","Cement Clinker Substitution",[0,1],"Cement Clinker Substitution"),
	(True,"Fraction of Potential Cogeneration and Waste Heat Recovery Adopted","Cogeneration and Waste Heat Recovery",[0,0.5],"Cogeneration and Waste Heat Recovery"),
	...
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[cement and other carbonates]","Industry Energy Efficiency Standards - Cement",[0,0.25528],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[natural gas and petroleum systems]","Industry Energy Efficiency Standards - Natural Gas and Petroleum",[0,0.25528],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[iron and steel]","Industry Energy Efficiency Standards - Iron and Steel",[0,0.25528],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[chemicals]","Industry Energy Efficiency Standards - Chemicals",[0,0.25528],"Industry Energy Efficiency Standards"),
	...
	(True,"Fraction of Methane Capture Opportunities Achieved","Methane Capture",[0,0.968686119],"Methane Capture and Destruction"),
	...
	(True,"Carbon Tax[transportation sector]","Carbon Tax - Transportation Sector",[0,83.56],"Carbon Tax"),
	(True,"Carbon Tax[electricity sector]","Carbon Tax - Electricity Sector",[0,83.56],"Carbon Tax"),
	(True,"Carbon Tax[residential buildings sector]","Carbon Tax - Residential Bldg Sector",[0,83.56],"Carbon Tax"),
	(True,"Carbon Tax[commercial buildings sector]","Carbon Tax - Commercial Bldg Sector",[0,83.56],"Carbon Tax"),
	(True,"Carbon Tax[industry sector]","Carbon Tax - Industry Sector",[0,83.56],"Carbon Tax"),
