...
SubsidyWind = (False,"Subsidy for Elec Production by Fuel[wind es]","SubsidyWind",[0,60])
...
ReduceFGases = (False,"Fraction of CO2e from Vented Byproduct Gasses Avoided","ReduceFGases",[0,1])
...
IndstSwitchFromCoal = (False,"Fraction of Coal Use Converted to Other Fuels","IndstSwitchFromCoal",[0,.25])
...
HeatSwitchFromCoal = (False,"Fraction of District Heat Coal Use Converted to Other Fuels","HeatSwitchFromCoal",[0,1])
