...
ElecPsgrLDVs = (False,"Percent Nonelec Vehicles Shifted to Elec by End Year[passenger,LDVs]","ElecPsgrLDVs",[0,.1])
ElecPsgrHDVs = (False,"Percent Nonelec Vehicles Shifted to Elec by End Year[passenger,HDVs]","ElecPsgrHDVs",[0,.1])
Feebate = (False,"LDVs Feebate Rate","Feebate",[0,1940])
FuelEconLDVs = (False,"Percentage Additional Improvement of Fuel Economy Std by End Year[LDVs]","FuelEconLDVs",[0,.22])
FuelEconHDVs = (False,"Percentage Additional Improvement of Fuel Economy Std by End Year[HDVs]","FuelEconHDVs",[0,.46])
TDM = (False,"Fraction of TDM Package Implemented by End Year","TDM",[0,1])
...
ComponentStdsHeating = (False,"Reduction in E Use Allowed by Component Eff Std by End Year[heating]","ComponentStdsHeating",[0,.68])
ComponentStdsCooling = (False,"Reduction in E Use Allowed by Component Eff Std by End Year[cooling and ventilation]","ComponentStdsCooling",[0,.68])
ComponentStdsEnvelope = (False,"Reduction in E Use Allowed by Component Eff Std by End Year[envelope]","ComponentStdsEnvelope",[0,.68])
ComponentStdsLighting = (False,"Reduction in E Use Allowed by Component Eff Std by End Year[lighting]","ComponentStdsLighting",[0,.68])
ComponentStdsAppliances = (False,"Reduction in E Use Allowed by Component Eff Std by End Year[appliances]","ComponentStdsAppliances",[0,.68])
ComponentStdsOther = (False,"Reduction in E Use Allowed by Component Eff Std by End Year[other component]","ComponentStdsOther",[0,.68])
...
ElecBldgCpnt = (False,"Percent New Nonelec Component Sales Shifted to Elec by End Year","ElecBldgCpnt",[0,.98])
...
RPS = (False,"Renewable Portfolio Std Percentage in End Year","RPS",[0,.35])
...
EarlyRetNatGas = (False,"Annual Additional Capacity Retired due to Early Retirement Policy[natural gas es]","EarlyRetNatGas",[0,10000])
...
LifeExtNatGas = (False,"Generation Capacity Lifetime Extension[natural gas es]","LifeExtNatGas",[0,20])
...
TransmissionGrowth = (False,"Percentage Increase in Transmission Capacity vs BAU by End Year","TransmissionGrowth",[0,.21])

# Industrial Sector (Including Agriculture) Policies
RedNonmethVent = (False,"Fraction of CO2e from Vented Byproduct Gasses Avoided by End Year","RedNonmethVent",[0,1])
MethaneDestr = (False,"Fraction of Methane Destruction Opportunities Achieved by End Year","MethaneDestr",[0,1])
WorkerTraining = (False,"Fraction of Addressable Process Emissions Avoided via Worker Training by End Year","WorkerTraining",[0,1])
ClinkerSubst = (False,"Fraction of Cement Clinker Substitution Made by End Year","ClinkerSubst",[0,1])
MethaneCapture = (False,"Fraction of Methane Capture Opportunities Achieved by End Year","MethaneCapture",[0,1])
CroplandMgmt = (False,"Fraction of Abatement from Cropland Management Achieved by End Year","CroplandMgmt",[0,1])
RiceCultivMeasures = (False,"Fraction of Abatement from Rice Cultivation Measures Achieved by End Year","RiceCultivMeasures",[0,1])
LivestockMeasures = (False,"Fraction of Abatement from Livestock Measures Achieved by End Year","LivestockMeasures",[0,1])
EarlyRetIndustry = (False,"Fraction of Energy Savings from Early Facility Retirement Achieved","EarlyRetIndustry",[0,1])
ImprSystemDesign = (False,"Fraction of Installation and System Integration Issues Remedied by End Year","ImprSystemDesign",[0,1])
CogenWasteHeat = (False,"Fraction of Potential Cogeneration and Waste Heat Recovery Adopted by End Year","CogenWasteHeat",[0,1])
IndstFuelSwitch = (False,"Fraction of Coal Use Converted to Other Fuels by End Year","IndstFuelSwitch",[0,.17])
IndstEffStdsCement = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[cement and other carbonates]","IndstEffStdsCement",[0,.11])
IndstEffStdsNGPS = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[natural gas and petroleum systems]","IndstEffStdsNGPS",[0,.11])
IndstEffStdsIronSteel = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[iron and steel]","IndstEffStdsIronSteel",[0,.11])
IndstEffStdsChemicals = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[chemicals]","IndstEffStdsChemicals",[0,.11])
IndstEffStdsMining = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[mining]","IndstEffStdsMining",[0,.11])
IndstEffStdsWasteMgmt = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[waste management]","IndstEffStdsWasteMgmt",[0,.11])
IndstEffStdsAg = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[agriculture]","IndstEffStdsAg",[0,.11])
IndstEffStdsOtherInd = (False,"Percentage Improvement in Eqpt Efficiency Standards above BAU by End Year[other industries]","IndstEffStdsOtherInd",[0,.11])
...
CarbonTax = (False,"Carbon Tax by End Year","CarbonTax",[0,100])
...
ConvertNonCHPHeat = (False,"Fraction of Non CHP Heat Production Converted to CHP by End Year","ConvertNonCHPHeat",[0,1])
FuelTaxElec = (False,"Additional Fuel Tax Rate by Fuel by End Year[electricity]","FuelTaxElec",[0,.2])
FuelTaxCoal = (False,"Additional Fuel Tax Rate by Fuel by End Year[coal]","FuelTaxCoal",[0,.2])
FuelTaxNatGas = (False,"Additional Fuel Tax Rate by Fuel by End Year[natural gas]","FuelTaxNatGas",[0,.2])
FuelTaxNuclear = (False,"Additional Fuel Tax Rate by Fuel by End Year[nuclear]","FuelTaxNuclear",[0,.2])
FuelTaxBiomass = (False,"Additional Fuel Tax Rate by Fuel by End Year[biomass]","FuelTaxBiomass",[0,.2])
FuelTaxPetGas = (False,"Additional Fuel Tax Rate by Fuel by End Year[petroleum gasoline]","FuelTaxPetGas",[0,.2])
FuelTaxPetDies = (False,"Additional Fuel Tax Rate by Fuel by End Year[petroleum diesel]","FuelTaxPetDies",[0,.2])
FuelTaxBioGas = (False,"Additional Fuel Tax Rate by Fuel by End Year[biofuel gasoline]","FuelTaxBioGas",[0,.2])
FuelTaxBioDies = (False,"Additional Fuel Tax Rate by Fuel by End Year[biofuel diesel]","FuelTaxBioDies",[0,.2])
FuelTaxJetFuel = (False,"Additional Fuel Tax Rate by Fuel by End Year[jet fuel]","FuelTaxJetFuel",[0,.2])
FuelTaxHeat = (False,"Additional Fuel Tax Rate by Fuel by End Year[heat]","FuelTaxHeat",[0,.2])
