...
PotentialPolicies = (
	...
	(True,"Percentage Additional Improvement of Fuel Economy Std[gasoline vehicle,LDVs]","Fuel Economy Standard - Gasoline Engine LDVs",[0,.5],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[diesel vehicle,HDVs]","Fuel Economy Standard - Diesel Engine HDVs",[0,0.5],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[nonroad vehicle,aircraft]","Fuel Economy Standard - All Aircraft",[0,0.25],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[nonroad vehicle,rail]","Fuel Economy Standard - All Rail",[0,0.2],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[nonroad vehicle,ships]","Fuel Economy Standard - All Ships",[0,0.2],"Vehicle Fuel Economy Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,urban residential]","Building Energy Efficiency Standards - Urban Residential Heating",[0,0.2],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,urban residential]","Building Energy Efficiency Standards - Urban Residential Cooling and Ventilation",[0,0.35],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,urban residential]","Building Energy Efficiency Standards - Urban Residential Envelope",[0,0.2],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,urban residential]","Building Energy Efficiency Standards - Urban Residential Lighting",[0,0.35],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,urban residential]","Building Energy Efficiency Standards - Urban Residential Appliances",[0,0.35],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,rural residential]","Building Energy Efficiency Standards - Rural Residential Heating",[0,0.2],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,rural residential]","Building Energy Efficiency Standards - Rural Residential Cooling and Ventilation",[0,0.35],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,rural residential]","Building Energy Efficiency Standards - Rural Residential Envelope",[0,0.2],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,rural residential]","Building Energy Efficiency Standards - Rural Residential Lighting",[0,0.35],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,rural residential]","Building Energy Efficiency Standards - Rural Residential Appliances",[0,0.35],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,commercial]","Building Energy Efficiency Standards - Commercial Heating",[0,0.2],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,commercial]","Building Energy Efficiency Standards - Commercial Cooling and Ventilation",[0,0.35],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,commercial]","Building Energy Efficiency Standards - Commercial Envelope",[0,0.2],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,commercial]","Building Energy Efficiency Standards - Commercial Lighting",[0,0.35],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,commercial]","Building Energy Efficiency Standards - Commercial Appliances",[0,0.35],"Building Energy Efficiency Standards"),
	...
	(True,"Annual Additional Capacity Retired due to Early Retirement Policy[hard coal es]","Early Retirement of Power Plants - Hard Coal",[0,3000],"Early Retirement of Power Plants"),
	...
	(True,"Percentage Increase in Transmission Capacity vs BAU","Increase Transmission",[0,0.35],"Increase Transmission"),
	...
	(True,"Additional Renewable Portfolio Std Percentage","Renewable Portfolio Standard",[0,0.62],"Renewable Portfolio Standard"),
	...
	(True,"Fraction of Potential Cogeneration and Waste Heat Recovery Adopted","Cogeneration and Waste Heat Recovery",[0,.9],"Cogeneration and Waste Heat Recovery"),
	...
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[cement and other carbonates]","Industry Energy Efficiency Standards - Cement",[0,0.2],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[natural gas and petroleum systems]","Industry Energy Efficiency Standards - Natural Gas and Petroleum",[0,0.2],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[iron and steel]","Industry Energy Efficiency Standards - Iron and Steel",[0,0.2],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[chemicals]","Industry Energy Efficiency Standards - Chemicals",[0,0.2],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[mining]","Industry Energy Efficiency Standards - Mining",[0,0.2],"Industry Energy Efficiency Standards"),
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[waste management]","Industry Energy Efficiency Standards - Waste Management",[0,0.2],"Industry Energy Efficiency Standards"),
	...
	(True,"Fraction of Methane Capture Opportunities Achieved","Methane Capture",[0,.9],"Methane Capture and Destruction"),
	(True,"Fraction of Methane Destruction Opportunities Achieved","Methane Destruction",[0,.9],"Methane Capture and Destruction"),
	(True,"Fraction of F Gases Avoided","Reduce F-gases",[0,.9],"Reduce F-gases"),
	...
	(True,"Fraction of Abatement from Livestock Measures Achieved","Livestock Measures",[0,.9],"Livestock Measures"),
	...
	(True,"Carbon Tax[transportation sector]","Carbon Tax - Transportation Sector",[0,100],"Carbon Tax"),
	(True,"Carbon Tax[electricity sector]","Carbon Tax - Electricity Sector",[0,100],"Carbon Tax"),
	(True,"Carbon Tax[residential buildings sector]","Carbon Tax - Residential Bldg Sector",[0,100],"Carbon Tax"),
	(True,"Carbon Tax[commercial buildings sector]","Carbon Tax - Commercial Bldg Sector",[0,100],"Carbon Tax"),
	(True,"Carbon Tax[industry sector]","Carbon Tax - Industry Sector",[0,100],"Carbon Tax"),
